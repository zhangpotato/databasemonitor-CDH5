...
public class ServiceStatus {
    public static HashMap<String, Integer> getServiceStatus() {
        ...
        String path = "/api/v19/clusters/" + PropertiesInfo.getConfProperty().getProperty("Cluster_Name") + "/services";
        ...
        String serviceBaseUrl = "http://" + PropertiesInfo.getConfProperty().getProperty("LongDBAdmin_Address") + ":";
